 ...
 */
@WebServlet(name = "BatteryLowHourServlet", urlPatterns = "/batteryLowHour")
public class BatteryLowHourServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        LinkedHashMap<String, Integer> map = BatteryJSON.getLowBatteryHourInfo();
